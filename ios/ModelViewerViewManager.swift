...
@objc(ModelViewerViewManager)
class ModelViewerViewManager: RCTViewManager {

  override func view() -> (ModelViewerView) {
...
class ModelViewerView : UIView {
    var _rootController = ModelViewController.init();
    var _url = String()
    var _numberOfLoad = 0
